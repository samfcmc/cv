...
% CONTACT INFORMATION
%====================
\def\name{Samuel Coelho} % Name Here
\def\phone{(351) 915010563}
\def\city{Montijo, Setúbal}
\def\email{samuelfcmc@gmail.com}
\def\LinkedIn{samfcmc} % linkedin.com/in/______
\def\github{samfcmc} % github username
